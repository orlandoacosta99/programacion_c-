...
namespace CompraloTo.Controllers
{
    ...
    public sealed class ProductsController : Controller
    {
        ...
        public async Task<ActionResult> ProductsView()
        {
            ...
            {
                products = await _queryService.GetProductList(), 
        ...
        [HttpGet]
        [Route("list")]
        public async Task<ActionResult> ProductsListView(GetProductListRequest request)
        {
            return PartialView("ProductsListView", new ProductListViewModel() {
                
                products = await _queryService.GetProductList(request),
